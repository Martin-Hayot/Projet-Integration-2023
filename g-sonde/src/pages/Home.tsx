			...
			{isDesktop ? (
				...
				<div>
					...
					<section className="bg-aquarium dark:bg-aquarium mx-auto text-center h-screen bg-cover bg-center bg-no-repeat relative">
						...
						<div className="group relative m-0 flex w-full h-full sm:w-48 sm:h-36 md:w-72 md:h-56 lg:w-96 lg:h-72 max-w-96 max-h-72 rounded-xl shadow-xl ring-gray-900/5 sm:mx-auto sm:max-w-lg" onClick={() => history.push("/login")}>
